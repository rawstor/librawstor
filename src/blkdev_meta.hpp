...
// Encodes a RawstorObjectSyncState as a compact colon-separated string of
// hex fields, e.g. "state=0:epoch=0:sync_id=0:h0=0:h1=0:h2=0:h3=0". Used as
// the payload of a ZFS user property or (prefixed by the caller) an LVM
// tag: only characters valid in both are used (no comma, no whitespace).
