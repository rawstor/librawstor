...
### Added
- `rawio::Queue::timeout()`: a standalone async timer op, co_await-able and cancellable exactly like every other `rawio::Queue` operation, resolving successfully once a given number of microseconds have elapsed.
