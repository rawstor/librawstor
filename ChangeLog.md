...
- Publish the Python bindings to PyPI as `rawstor`, as a single self-contained `abi3` wheel (Python >= 3.9) alongside the existing `python3-rawstor` deb/rpm packages.
