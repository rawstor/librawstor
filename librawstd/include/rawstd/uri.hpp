#ifndef RAWSTD_URI_HPP
#define RAWSTD_URI_HPP
...
public:
    static std::vector<rawstd::URI> uriv(const char* uris);
    static std::string uris(const std::vector<rawstd::URI>& uriv);
