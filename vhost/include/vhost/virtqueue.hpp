...
private:
    ...
    using Command = std::variant<
        ...
        SetVringAddr, SetEnabled, GetVringBase, Pause, Resume, Shutdown>;
...
public:
    ...
    // --- cross-thread policy: callable only from the control-plane
    // thread, only once this VirtQueue is running(). ---
