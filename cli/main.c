...
static void command_info_usage(void) {
    fprintf(
        stdout, "Rawstor CLI " PACKAGE_VERSION "\n"
                ...
                "command options:\n"
                "  -h, --help            Show this help message and exit\n"
                "  -l, --logical         Show \"used\" as each object's own "
                "declared size,\n"
                "                        summed, instead of the location's "
                "actual physical\n"
                "                        usage (the two can diverge, e.g. "
                "for sparse\n"
                "                        objects). \"total\"/\"use%%\" "
                "still reflect actual\n"
                "                        physical capacity; \"available\" "
                "has no logical\n"
                "                        counterpart and isn't shown.\n"
